...
Criatura:
	...
	El jugador controla una criatura acuática.
	El objetivo es explorar el océano, encontrar comida y evitar depredadores.
	El jugador puede evolucionar su criatura agregando nuevas partes y habilidades.
	Los otros animales tienen IA básica y pueden cazar o huir.
...
Feudal: 
	...
	este estadio es especial por que No termina en si aun puede acceder sus caracteristicas desde espacio y civilización
...
5. ExoGenesis
6. BioEra
creo que suenan muy EPICOS para un juego todo cute y low poly como este XD
 es decir no se si quiero un nombre tan epico
NUEVAS IDEAS:
1. MicroMundo
2. Adaptaville
3. BioJourney
4. VidaLúdica (que bueno que no gano este nombre XD)
5. EvoLúdico
6. MundoCélula ( ni este eso suena a juego de moviles para niños XD)
...
la silaba tonica de Adaptica es la "ti" asi que se pronuncia "Adaptíca" y no "Adapticá" XD pues 
Adapticá es una conjugación del verbo imaginario
Adapticar.
y Ádaptica no existe
ademas segun las reglas del español Las palabras llanas (o graves) acabadas en «n», «s» o vocal no llevan tilde.
